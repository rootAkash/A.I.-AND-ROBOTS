...
ser2 = serial.Serial('COM7',115200,timeout=None)
time.sleep(.1)
...
class DQN:
    ...
    def save_model(self):
        self.model.save("keras_save.h5","Users\Robotics Lab\Desktop",overwrite=True,include_optimiser=True)
    def load_model(self):
        self.model=load_model("keras_save.h5")
